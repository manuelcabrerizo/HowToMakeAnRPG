...
PUSHD ..\build
cl %compilerFLags% ..\src\win32_platform.cpp ..\libs\glad\src\glad.c ..\libs\lua\src\*.c -Fewin32_engine /I%includeGLMPath% /I%includeGLADPath% /I%includeGLPath% %defines% /link %linkerFlags% /subsystem:console
POPD
